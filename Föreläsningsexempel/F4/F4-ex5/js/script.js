...
function init() {
	...
	document.getElementById("saveBtn").addEventListener("click",function() { courses.save(); });
	document.getElementById("loadBtn").addEventListener("click",function() { courses.load(); });
} // End init
